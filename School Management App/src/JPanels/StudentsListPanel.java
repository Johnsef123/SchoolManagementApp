...
import JFrames.Create_UpdateFrameStudents;
...
public class StudentsListPanel extends JPanel {
    ...
    public StudentsListPanel(){
        ...
        listPanel.setBounds(0,150,width,height-150);
            ...
            String [] columnNames = {"ID","First Name", "Surname", "Birth Date", "",""};
            ...
            List <Student> studentsShowedInTable = studentDao.getStudents();
            for(Student student : studentsShowedInTable){
                Object[] rowData={
                    student.getId(),
                    student.getFName(),
                    student.getLName(),
                    formatter.format(student.getBirthDate()),
                        //some inline html to style the selected texts
        ...
        //Disable the reordering of the title row
        ...
        createButton.addActionListener(e->{
            Create_UpdateFrameStudents createUpdateFrame = new Create_UpdateFrameStudents(null);
        ...
        searchField.addActionListener(e->{
            ...
            studentsShowedInTable.clear();

            for(Student s : studentDao.getStudents()){
                if(s.getLName().toLowerCase().contains(searchText.toLowerCase())){
                    studentsShowedInTable.add(s);
                }
            }

            StudentsListFrame studentsListFrame = new StudentsListFrame(studentsShowedInTable);
        ...
        table.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if(col==5){
                    ...
                    int confirm = JOptionPane.showConfirmDialog(null,"Are you sure you want to delete the student with ID number " +String.valueOf(id)+ " ?",
                ...
                //Update Function
                    ...
                    for(Student s : studentDao.getStudents()){
                        if(s.getId()==Integer.parseInt(table.getValueAt(row,0).toString())){
                            student = s;
                        }
                    }
                    Create_UpdateFrameStudents createUpdateFrame = new Create_UpdateFrameStudents(student);
    ...
    //Second Constructor for filtering

    public StudentsListPanel(List<Student> filteredStudents){
        setBackground(MainFrame.whiteColor);
        setLayout(null);
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/YYYY");
        //add the data on the table by getting the students list from the studentDAO class
        List <Student> studentsShowedInTable = filteredStudents;
        for(Student student : studentsShowedInTable){
            Object[] rowData={
                    student.getId(),
                    student.getFName(),
        ...
        table.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if(col==5){
                    int id = Integer.parseInt(table.getValueAt(row,0).toString());
                    int confirm = JOptionPane.showConfirmDialog(null,"Are you sure you want to delete the student with ID number " +String.valueOf(id)+ " ?","Confirm Deletion", JOptionPane.YES_NO_OPTION,JOptionPane.WARNING_MESSAGE);
